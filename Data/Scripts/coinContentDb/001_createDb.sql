USE [master]
GO
/****** Object:  Database [coinContentDb]    Script Date: 25.04.2016 18:44:27 ******/
CREATE DATABASE [coinContentDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'coinContentDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.BIOHAZARD\MSSQL\DATA\coinContentDb.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'coinContentDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.BIOHAZARD\MSSQL\DATA\coinContentDb_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [coinContentDb] SET COMPATIBILITY_LEVEL = 120
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [coinContentDb].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [coinContentDb] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [coinContentDb] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [coinContentDb] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [coinContentDb] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [coinContentDb] SET ARITHABORT OFF 
GO
ALTER DATABASE [coinContentDb] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [coinContentDb] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [coinContentDb] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [coinContentDb] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [coinContentDb] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [coinContentDb] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [coinContentDb] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [coinContentDb] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [coinContentDb] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [coinContentDb] SET  DISABLE_BROKER 
GO
ALTER DATABASE [coinContentDb] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [coinContentDb] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [coinContentDb] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [coinContentDb] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [coinContentDb] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [coinContentDb] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [coinContentDb] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [coinContentDb] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [coinContentDb] SET  MULTI_USER 
GO
ALTER DATABASE [coinContentDb] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [coinContentDb] SET DB_CHAINING OFF 
GO
ALTER DATABASE [coinContentDb] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [coinContentDb] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [coinContentDb] SET DELAYED_DURABILITY = DISABLED 
GO
USE [coinContentDb]
GO
...
USE [master]
GO
ALTER DATABASE [coinContentDb] SET  READ_WRITE 
GO
