INSERT INTO [dbo].[Templates] ([Header], [Body], [Footer], [Id], [Name], [IsDefault], [UserId], [Links]) VALUES (N'<div class="navbar-wrapper">
      <div class="container">
...
INSERT INTO [dbo].[Templates] ([Header], [Body], [Footer], [Id], [Name], [IsDefault], [UserId], [Links]) VALUES (N' ', N'<div class="site-wrapper">
...
<link href="Content/Templates/Default/Mini/cover.css" rel="stylesheet">
    ...
    <script src="Scripts/bootstrap.min.js"></script>
    <script src="Scripts/Templates/Default/Shared/docs.min.js"></script>')
INSERT INTO [dbo].[Templates] ([Header], [Body], [Footer], [Id], [Name], [IsDefault], [UserId], [Links]) VALUES (N' ', N'<section class="navigation">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <h1 class="animated bounceInDown">�������� ��������� � �������� ��������.</h1>
              <p class="animated fadeInUpDelay">���? ����� �� ���� ������ ����� ��������, ���������� ������� ����������:</p>
            </div>
          </div>
          <div class="row">
...
<section class="hero" id="hero">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
                <a id="userRegistrLink" href="" class="get-started-btn">������ ������������!</a>
            </div>
        </div>
    </div>
</section>', N'<footer>
