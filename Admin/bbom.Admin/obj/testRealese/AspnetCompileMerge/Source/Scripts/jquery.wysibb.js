...
//			direction:			"ltr",
	...
	$.wysibb.prototype = {
		...
		init:	function() {
			...
			//phpbb2
			this.$txtArea.parents("form").find("input[id*='preview'],input[id*='submit'],input[class*='preview'],input[class*='createEvent'],input[name*='preview'],input[name*='createEvent']").bind("mousedown",$.proxy(function() {
				this.sync();
