...
namespace bbom.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            await CoreFasade.UsersHelper.UpdateCookie();
        ...
        public ActionResult Contact()
        {
            ...
            try
            {
                link = user.ReceivedExtraRegParams.FirstOrDefault()
                    .UserExtraRegParams.FirstOrDefault(param => param.AspNetUser == user.InvitedAspNetUser).Value;
            }
            catch
            {
                //ignore
