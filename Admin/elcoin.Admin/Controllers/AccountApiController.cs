...
using bbom.Admin.Core.Providers;
using bbom.Admin.Core.ViewModels.Account;
using elcoin.Admin.Results;
...
namespace elcoin.Admin.Controllers
{
    ...
    public class AccountApiController : ApiController
    {
        ...
        {
            IdentityUser user = await UserManager.FindByIdAsync(User.GetUserId());
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.AddLoginAsync(User.GetUserId(),
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            {
                result = await UserManager.RemovePasswordAsync(User.GetUserId());
            }
            else
            {
                result = await UserManager.RemoveLoginAsync(User.GetUserId(),
